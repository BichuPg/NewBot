...
BOT_TOKEN = environ.get('BOT_TOKEN', "6489182880:AAG_bbHf0FEL2Y4RDKrq6DVTxYb66FQ8HgY")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5097048997').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001665499479')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001971293512')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001971293512')
...
STREAM_BIN = environ.get("STREAM_BIN", "-1001904849004") #Log channel/Bin Channel id -100xxxxxxx
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+AKANipq4DHhkYjk9')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001757784655'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+AKANipq4DHhkYjk9')
